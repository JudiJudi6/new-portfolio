...
export default function SectionExp({ scrollY }: { scrollY: number }) {
  return (
    <section className="h-screen w-full flex flex-col justify-between items-center px-4 pt-8 pb-2 sm:px-6 sm:pb-4 max-w-[1500px] mx-auto">
      <div></div>
      <motion.div
        className="font-semibold tracking-wide max-w-[800px] text-center uppercase"
        style={{ translateY: (scrollY / 6) * -1 + 250 }}
      >
        <motion.p
